...
#	kernel modules
	...
	install -m 755 ${S}/misc-modules/hello.ko  ${D}${base_libdir}/modules/${KERNEL_VERSION}/extra/
	install -m 755 ${S}/misc-modules/faulty.ko ${D}${base_libdir}/modules/${KERNEL_VERSION}/extra/

#	scripts to /usr/bin
#	install -m 755 ${S}/misc-modules/module_load ${D}${base_libdir}/modules/${KERNEL_VERSION}/extra/
#	install -m 755 ${S}/misc-modules/module_unload ${D}${base_libdir}/modules/${KERNEL_VERSION}/extra/
	install -d ${D}${bindir}
	install -m 755 ${S}/misc-modules/module_load   ${D}${bindir}/
	install -m 755 ${S}/misc-modules/module_unload ${D}${bindir}/
}
